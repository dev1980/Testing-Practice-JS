...
const shift = (char, key) => {
  ...
  if (charCode <= 90 && charCode >= 65 || charCode <= 122 && charCode >= 97) {
    return String.fromCharCode(shiftMod(charCode + key - charGroup(charCode), 26) + charGroup(charCode));
  }
  return char;
};
console.log(caesar('caesar cipher, and his crypto Algorithms!', 18));
